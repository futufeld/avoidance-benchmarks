...
impl Vehicle {
    ...
    // Returns the potential corresponding to the given obstacle.
    pub fn potential(&self, point: Vec2D, obstacle: &Box<HasSource>)
        -> Option<(Vec2D, f64)>
    {
        // Determine repulsor.
        let source = obstacle.source(point);
        ...
        -> Option<Vec2D>
    {
        ...
        for obstacle in obstacles.iter() {
            if let Some(v) = self.potential(point, obstacle) {
                potentials.push(v);
            }
        }
